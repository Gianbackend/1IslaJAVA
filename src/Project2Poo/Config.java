...
public final class Config {
    ...
    static {
        // Herbívoros (más alta)
        MIGRATION_PROB.put(Species.ORUGA,   0.05); // orugas recolonizan mucho
        MIGRATION_PROB.put(Species.RATON,   0.03);
        MIGRATION_PROB.put(Species.CONEJO,  0.02);
        MIGRATION_PROB.put(Species.PATO,    0.015);
        MIGRATION_PROB.put(Species.OVEJA,   0.01);
        MIGRATION_PROB.put(Species.CABRA,   0.01);
